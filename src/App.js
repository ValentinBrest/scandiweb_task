...
class App extends Component {
    ...
    giveToCart = (order) => {
        ...
        if (!hasProduct) {
            ...
            this.setState({
                ...
                counters: { ...this.state.counters, [order.id]: 1 },
                totalPrice: { ...this.state.totalPrice, [order.id]: money },
            });
        } else {
            let money = {};
    ...
    addInCounters = (counter, index, price) => {
        this.setState(
            ...
            () => {
                this.setState({
                    totalAmount: this.sumSalaries(this.state.totalPrice, this.state.symbol),
                });
            }
        );
    };
