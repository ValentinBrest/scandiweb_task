            ...
            <div className={cl.prodList__wrap}>
                    ...
                    {this.props.inStock
                        ?<div className={cl.green__cart__box}>
                            <div className={cl.green__cart} onClick={this.props.attr.length == 0 ?() => this.addToCart(this.props.brand, this.props.name, this.props.symbol, this.props.prices, this.props.gallery): ()=> {}}></div>
