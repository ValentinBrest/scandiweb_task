...
import mcl from './MinibagOrder/MinibagOrder.module.css';
            ...
            <div className={this.getClassName('order__wrap')}>
                <div className={cl.left__info}>
                    ...
                    <div className={this.getClassName('price')}>
                        {this.props.symbol}
                        {
                            this.props.price.filter(
                                (cur) => cur.currency.symbol === this.props.symbol
                            )[0].amount
                        }
                    </div>
                ...
                <div className={this.getClassName('right__info')}>
                    <div className={this.getClassName('button__wrap')}>
                        <button className={this.getClassName('button')}>
                            <div
                                className={this.getClassName('button__plus')}
                        ...
                        <button className={this.getClassName('button')}>
                            <div
                                className={this.getClassName('button__minus')}
                    ...
                    <div className={this.getClassName('img__block')}>
                        {this.props.gallery.length > 1 ? (
                            <>
                                <div
                                    className={cl.arrow_left}
                                    onClick={() => this.changeImg('back')}
                                ></div>
                                <div
                                    className={cl.arrow_right}
                                    onClick={() => this.changeImg('go')}
                                ></div>
                            </>
                        ) : (
                            ''
                ...
                <button
                    className={this.getClassName('button__delete')}
